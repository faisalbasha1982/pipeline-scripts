...
ls -ahl
cd thanos-gauntlet-u-dbo-ver/templates
...
do
  ...
  if [ "$n" -eq 35 ]
  then
       envfile='/home/dotnet_user/env-python/env-db-ver.txt'
...
helm upgrade thanos-gauntlet-u-dbo-ver thanos-gauntlet-u-dbo-ver -n uat \
...
--set image.tag=$(Build.BuildNumber) -f thanos-gauntlet-u-dbo-ver/values.yaml \
