...
ls -ahl
cd thanos-gauntlet-u-dbo-rst/templates
...
do
  ...
  if [ "$n" -eq 35 ]
  then
       envfile='/home/dotnet_user/env-python/env-db-rst.txt'
...
helm upgrade thanos-gauntlet-u-dbo-rst thanos-gauntlet-u-dbo-rst -n uat \
...
--set image.tag=$(Build.BuildNumber) -f thanos-gauntlet-u-dbo-rst/values.yaml \
